...
```bash
pigo --provider amazon-bedrock --model us.anthropic.claude-sonnet-4-20250514-v1:0
```
...
pigo --provider amazon-bedrock --model arn:aws:bedrock:us-east-1:123456789012:application-inference-profile/abc123
```
...
pigo --provider cloudflare-ai-gateway --model "claude-sonnet-4-5"
```
...
export CLOUDFLARE_API_KEY=...           # or use /login
export CLOUDFLARE_ACCOUNT_ID=...
pigo --provider cloudflare-workers-ai --model "@cf/moonshotai/kimi-k2.6"
```
